...
const resetPasswordForm = ref<VForm>()
      ...
      <VRow no-gutters>
        ...
        >
          ...
          <p class="text-body-1 text-medium-emphasis mb-5">
            Renseignez le code reçu et choisissez un mot de passe sécurisé.
          </p>
          ...
          <VAlert
            ...
            class="mb-6"
          >
            Compte : <strong>{{ form.email || 'adresse e-mail requise' }}</strong>
          </VAlert>
          ...
          >
            ...
            <VTextField
              ...
              :rules="[v => !!v || 'Mot de passe requis', v => (v?.length >= 8) || '8 caractères minimum']"
            ...
            <div class="panel-overlay">
              <div>
                ...
                <p class="panel-text mb-6">
                  Restaurez votre mot de passe et reprenez vos opérations en toute confiance.
                </p>
              ...
              <div class="illustration-card">
                ...
                <div>
                  ...
                  <p class="panel-text mb-0">
                    Utilisez un mot de passe unique et confidentiel.
                  </p>
                </div>
              </div>
            </div>
